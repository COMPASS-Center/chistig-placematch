...
chistig_colocation_params$agent.log.file <- paste0(this_dir, "output/agent_log_", treatment_run, "_", experiment_name, "_", calibration_set_num, ".txt")
...
#
# Necessary files
epistats <- readRDS(paste0(this_dir, "data/input/epistats-local.rds"))
netstats <- readRDS(paste0(this_dir, "data/input/netstats_", experiment_name, "_", calibration_set_num, ".rds"))

if (treatment == 'venues'){
  est <- readRDS(paste0(this_dir, "data/input/venues_netest_", experiment_name, "_", calibration_set_num, ".rds"))
} else if (treatment == 'apps'){
  est <- readRDS(paste0(this_dir, "data/input/apps_netest_", experiment_name, "_", calibration_set_num, ".rds"))
} else if (treatment == 'both'){
  est <- readRDS(paste0(this_dir, "data/input/both_netest_", experiment_name, "_", calibration_set_num, ".rds"))
} else if (treatment == 'control') {
  est <- readRDS(paste0(this_dir, "data/input/control_netest_", experiment_name, "_", calibration_set_num, ".rds"))
} else {
  print("ERROR: invalid treatment type code provided")
}

...
Rscript step1_edge_calibration.R 02-edge-calibration.yaml
...
Rscript step2a_edge_calibration.R 02-edge-calibration.yaml
...
python step2b_setup_ergm_fit_procedure.py 02-edge-calibration.yaml

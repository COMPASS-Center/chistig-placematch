...
parser.add_argument("--yaml", type=str, required=True, help="YAML file for this script.")
...
# # print(yamldata)
print(yamldata['exp.name'])
print(yamldata['exp.dir'])
...
#     os.makedirs(directory)  # Creates parent directories if needed

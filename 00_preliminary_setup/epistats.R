...
# load RADAR data
radar_data <- readRDS(paste0(yamldata$acts.models.output.dir, yamldata$acts.models.output.fname))
output_fname <- paste0(yamldata$epistats.dir, yamldata$epistats.fname)

...
#SBATCH --array=0-119 ## number of jobs to run "in parallel"
...
#SBATCH --mem=3G
#SBATCH --job-name=%A.step4_1 ## When you run squeue -u NETID this is how you can identify the job
#SBATCH --output=/projects/p32153/chistig-placematch/04-chistig-model-simulation/interim/step4_1.%a_120.%A.out ## standard out and standard error goes to this file
#SBATCH --error=/projects/p32153/chistig-placematch/04-chistig-model-simulation/interim/step4_1.%a_120.%A.err

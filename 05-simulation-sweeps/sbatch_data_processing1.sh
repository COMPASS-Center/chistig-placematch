...
#SBATCH --output=/projects/p32153/chistig-placematch/05-simulation-sweeps/postprocessing1.out ## standard out and standard error goes to this file
#SBATCH --error=/projects/p32153/chistig-placematch/05-simulation-sweeps/postprocessing1.err
#SBATCH --mem=473G

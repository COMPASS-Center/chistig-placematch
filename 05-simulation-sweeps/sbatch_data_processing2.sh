...
#SBATCH --job-name=step5postprocessing2 ## When you run squeue -u NETID this is how you can identify the job
#SBATCH --output=/projects/p32153/chistig-placematch/05-simulation-sweeps/postprocessing2.out ## standard out and standard error goes to this file
#SBATCH --error=/projects/p32153/chistig-placematch/05-simulation-sweeps/postprocessing2.err
#SBATCH --mem=473G
...
SECONDS=0
Rscript /projects/p32153/chistig-placematch/05-simulation-sweeps/post_sweep_processing2.R
echo $SECONDS

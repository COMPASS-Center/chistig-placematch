...
#SBATCH --array=0-971 ## number of jobs to run "in parallel"
...
#SBATCH --mem=3G
#SBATCH --job-name="test16oct_%A" ## When you run squeue -u NETID this is how you can identify the job
#SBATCH --output=%a_972.%A.test18oct.out ## standard out and standard error goes to this file
...
IFS=$'\n' read -d '' -r -a input_args < step2_ergm_fit_procedure_input_args_test18oct.txt
...
my_random_seed_array=(6 24 116 149 126 9 130 58 29 0)
